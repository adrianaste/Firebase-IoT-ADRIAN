...
// LUCES LED (ALTA=AMARILLA [VA A 3,3V] Y BAJA=VERDE [VA A GND])
#define LED_AMARILLA_INPUT 13
#define LED_VERDE_INPUT 18

// LUZ RGB
#define RGB_RED_INPUT 14
#define RGB_GREEN_INPUT 27
#define RGB_BLUE_INPUT 26
...
void setup()
{
  ...
  // LUCES LED
  pinMode(LED_AMARILLA_INPUT, OUTPUT);
  pinMode(LED_VERDE_INPUT, OUTPUT);
  
  //LUZ RGB
  pinMode(RGB_RED_INPUT, OUTPUT);
  pinMode(RGB_GREEN_INPUT, OUTPUT);
  pinMode(RGB_BLUE_INPUT, OUTPUT);
